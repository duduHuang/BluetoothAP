...
public class DeviceList {
    ...
    public DeviceList(Activity a) {
        mAct = a;
        mAct.setContentView(R.layout.activity_device_list);

        // Set result CANCELED in case the user backs out
        mAct.setResult(Activity.RESULT_CANCELED);
        mView = mAct.findViewById(R.id.device_list);
        ...
        ArrayAdapter<String> pairedDevicesArrayAdapter = new ArrayAdapter<String>(mAct, R.layout.device_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(mAct, R.layout.device_name);
        ...
        if (pairedDevices.size() > 0) {
            ...
            String noDevices = mAct.getResources().getText(R.string.none_paired).toString();
    ...
    private void doDiscovery() {
        ...
        mAct.setTitle(R.string.scanning);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            mOnConnectionListener.getAddress(Activity.RESULT_OK, address);

            // Set result and finish this Activity
//            mAct.setResult(Activity.RESULT_OK, intent);
//            mAct.finish();
        }
    };
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                mAct.setTitle(R.string.select_device);
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    String noDevices = mAct.getResources().getText(R.string.none_found).toString();
    ...
    public interface onConnectionListener {
        void getAddress(int resultCode, String address);
    }
